...
export type SuccessfulResponse<TData, TRequestMethod extends RequestMethod> = {
  success: true;
  rawResponse: TRequestMethod extends "query" ? ApolloQueryResult<TData> : FetchResult;
};
export type FailedResponse = {
  success: false;
  rawResponse: ApolloError;
};
export type APIResponse<TRequest, TData, TRequestMethod extends RequestMethod> = (SuccessfulResponse<TData, TRequestMethod> | FailedResponse) & {
  request: TRequest;
};
...
export class BaseAPIClient {
  ...
  static async request<TRequest, TResponseData = any>(client: ApolloClient<unknown>, config: RequestConfig<TRequest, "query">, options: RequestOptions): Promise<APIResponse<TRequest, TResponseData, "query">>;
  static async request<TRequest, TResponseData = any>(client: ApolloClient<unknown>, config: RequestConfig<TRequest, "mutation">, options: RequestOptions): Promise<APIResponse<TRequest, TResponseData, "mutation">>;
  static async request<TRequest, TResponseData = any>(client: ApolloClient<unknown>, config: RequestConfig<TRequest, RequestMethod>, options: RequestOptions = {}): Promise<APIResponse<TRequest, TResponseData, RequestMethod>> {
    const {request, gql, requestMethod, variables, timeout, headers} = config;
